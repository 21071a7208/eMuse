...
fer_train_folder = 'data/train'
ckplus_train_folder = 'ck_data/train'  
merged_train_folder = 'merged_train'

# Create the merged training dataset folder if it doesn't exist
os.makedirs(merged_train_folder, exist_ok=True)
...
for emotion in emotion_labels:
    fer_emotion_folder = os.path.join(fer_train_folder, emotion)  # Use os.path.join for consistent path handling
    merged_emotion_folder = os.path.join(merged_train_folder, emotion)
